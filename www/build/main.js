...
var CodePage = (function () {
    ...
    CodePage.prototype.saveData = function () {
        ...
        this.crudPvr.createNewUser(this.datos).subscribe(function (data) {
            ...
            var email = _this.createOk.email;
            var password = _this.createOk.passwordHash;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_57__pages_form_register_form_register__ = __webpack_require__(618);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
        ...
        this.crudPvr.validateEmail(email).subscribe(function (data) {
            ...
            if (_this.resolve.result == "ok") {
                _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_7__code_code__["a" /* CodePage */], {
                    datos: datos, hora: _this.hora, available: _this.available, doctor: _this.doctor, resolve: _this.resolve
                });
            }
            else {
                var alert_1 = _this.alertCtrl.create({
